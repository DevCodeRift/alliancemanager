...
export default function TrainingModule() {
  ...
  const allowed = !!(info?.modules && info.modules.training) || !!info?.whitelisted
  return (
    <div style={{ padding: 24 }}>
      <h2>Training Module</h2>
      {!allowed ? <div className="members-panel">This module is locked for your alliance.</div> : <div className="members-panel">Training resources and schedules will appear here.</div>}
    </div>
  )
}
