...
export default function WarModule() {
  ...
  return (
    <div style={{ padding: 24 }}>
      <h2>War Module</h2>
      {!allowed ? <div className="members-panel">This module is locked for your alliance.</div> : <div className="members-panel">War tools and reports will appear here.</div>}
    </div>
  )
}
